...
files = ['app.py', 'output_sync.py', 'requirements.txt', 'README.md', 'sam3_local_runner.py',
         ...
         'tests/test_h3_turbo_ui.cjs', 'tests/test_output_sync.py', 'tests/test_output_sync_ui.cjs']
for name in files:
